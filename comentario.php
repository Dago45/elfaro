        ...
        <main>
            ...
            <body>
                <div class="container-form">
                    <div class="nfo-form">
                        <h2>Contactanos y entreganos tus comentarios.</h2>
                    ...
                    <form action="#" autocomplete="off">
                        <input id="nombre" type="text" name="nombre" placeholder="Ingresa tu nombre" class="campo">
                        <input id="correo" type="email" name="correo" placeholder="Ingresa tu correo" class="campo">
